...
const steps = [
  ...
  {
    t: "Distributing supplies",
    d: "Currently · 84 / 150 families served",
    done: false,
    current: true,
  },
  ...
  component: () => (
    ...
    >
      <p className="text-muted-foreground -mt-1 mb-6">
        Flood relief · Sector 12, Mumbai · Team Alpha-3
      </p>
                  ...
                  <li key={i} className="flex gap-2 items-start">
                    ...
                    <div className="flex-1">
                      <div className="text-xs">
                        <span className="font-medium">{m.n}</span> · {m.time}
                      </div>
                      <div>{m.t}</div>
                    </div>
                  </li>
            ...
            <CardContent className="p-5">
              ...
              <div className="rounded-2xl border bg-gradient-to-br from-primary/5 to-transparent p-5 text-center">
                ...
                <div className="text-xs text-muted-foreground mt-1">
                  to next checkpoint · ETA 4 min
                </div>
                <Button className="mt-4 rounded-full shadow-glow">
