...
export const Route = createFileRoute("/admin/health")({
  ...
  component: () => (
    <FeaturePage
      ...
      charts={[
        {
          title: "Load (% capacity) by service · 24h",
          type: "area",
          data,
          xKey: "t",
          series: [
      ...
      sideCards={[
        {
          ...
          items: [
            {
              label: "SMS gateway latency spike",
              value: <PillBadge tone="success">Resolved</PillBadge>,
            },
            {
              label: "EU replica failover drill",
              value: <PillBadge tone="muted">Scheduled</PillBadge>,
            },
            {
              label: "Cache warm-up after deploy",
              value: <PillBadge tone="success">Resolved</PillBadge>,
            },
          ],
        },
