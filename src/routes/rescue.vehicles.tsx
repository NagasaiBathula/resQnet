      ...
      tableCols={[
        {
          key: "callsign",
          label: "Callsign",
          render: (r) => <span className="font-mono text-xs">{r.callsign}</span>,
        },
        { key: "type", label: "Type" },
        ...
        },
        {
          ...
          label: "Fuel",
          render: (r) => (
            <span className={r.fuel < 30 ? "text-emergency text-xs font-medium" : "text-xs"}>
              {r.fuel}%
            </span>
          ),
        },
