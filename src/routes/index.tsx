      ...
      <div className="mx-auto max-w-6xl px-4 mt-4">
        <div className="glass-strong rounded-2xl flex items-center justify-between px-4 py-2.5 shadow-elegant">
          ...
          <nav className="hidden md:flex items-center gap-7 text-sm text-muted-foreground">
            ...
            <a href="#network" className="hover:text-foreground transition">
              Network
            </a>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button asChild size="sm" className="rounded-full">
              <Link to="/login">
                Launch demo <ArrowRight className="h-3.5 w-3.5 ml-1" />
              </Link>
            </Button>
          </div>
        </div>
    ...
    <section className="relative pt-36 pb-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-5xl px-6 text-center">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          <Badge
            variant="outline"
            className="rounded-full glass border-border/60 px-3 py-1 gap-1.5 mb-6"
          >
        ...
        >
          Turning chaos into
          <br />
          <span className="bg-gradient-to-r from-primary via-info to-emergency bg-clip-text text-transparent">
            coordinated action.
          </span>
        </motion.h1>
        <motion.p
        ...
        >
          The first end-to-end emergency operating system that connects citizens, volunteers, rescue
          teams, and authorities — orchestrated by AI in real time.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <Button asChild size="lg" className="rounded-full h-12 px-6 shadow-glow">
            <Link to="/login">
              Open live demo <ArrowRight className="h-4 w-4 ml-2" />
            </Link>
          </Button>
            ...
            <div className="rounded-2xl bg-card overflow-hidden border">
              ...
              <div className="px-4 pb-4 grid md:grid-cols-2 gap-3">
                <div className="rounded-xl border p-4 bg-gradient-to-br from-emergency/5 to-transparent">
                  <div className="flex items-center gap-2 text-xs text-emergency font-medium">
                    <span className="h-1.5 w-1.5 rounded-full bg-emergency animate-pulse" /> NEW SOS
                    · CC-2412
                  </div>
                  <p className="text-sm mt-1 font-medium">Flood reported · Sector 12, Mumbai</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    AI triage HIGH · Team Alpha-3 dispatched · ETA 7m
                  </p>
                </div>
                <div className="rounded-xl border p-4 bg-gradient-to-br from-success/5 to-transparent">
                  <div className="flex items-center gap-2 text-xs text-success font-medium">
                    <CheckCircle2 className="h-3 w-3" /> Resolved · CC-2389
                  </div>
                  <p className="text-sm mt-1 font-medium">42 citizens safely evacuated</p>
                  <p className="text-xs text-muted-foreground mt-1">
                    Shelter Civic Center 4 · 38 beds remaining
                  </p>
                </div>
              </div>
            </div>
  ...
  const items = [
    {
      icon: ShieldAlert,
      title: "One-tap SOS",
      desc: "Instantly notify rescue teams with location, photos, and AI severity classification.",
    },
    {
      icon: MessageSquareText,
      title: "AI disaster assistant",
      desc: "Conversational guidance for every emergency, available offline-first in 12 languages.",
    },
    {
      icon: Building2,
      title: "Shelter network",
      desc: "Live capacity, facilities, and routing across 30+ shelters in your region.",
    },
    {
      icon: Radio,
      title: "Dispatch command",
      desc: "Multi-agency coordination, vehicle tracking, and resource allocation in one canvas.",
    },
    {
      icon: BarChart3,
      title: "Predictive analytics",
      desc: "Forecast hotspots, allocate volunteers, and brief authorities with one-click reports.",
    },
    {
      icon: Globe2,
      title: "Government-grade",
      desc: "Audit logs, role-based access, and policy controls trusted by national disaster authorities.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-4xl font-bold tracking-tight">
            Every responder, on the same canvas.
          </h2>
          <p className="mt-3 text-muted-foreground">
            From the first SOS to post-incident reporting — one platform, one truth.
          </p>
        </div>
  ...
  const steps = [
    {
      n: "01",
      t: "Citizen reports",
      d: "Open the app, tap SOS or report any emergency in seconds. Location and media auto-attached.",
    },
    {
      n: "02",
      t: "AI triages",
      d: "Severity, type, and recommended response are classified within 800ms.",
    },
    {
      n: "03",
      t: "Network dispatches",
      d: "Volunteers and rescue teams nearby are matched and routed automatically.",
    },
    {
      n: "04",
      t: "Authority oversees",
      d: "National dashboards track every incident, asset, and outcome in real time.",
    },
  ];
  return (
      ...
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-6 gap-3">
          {cats.map((c) => (
            <div
              key={c.l}
              className="rounded-2xl border bg-card p-5 hover:shadow-elegant transition"
            >
              <div
                className={`h-11 w-11 mx-auto rounded-xl flex items-center justify-center ${c.c}`}
              >
      ...
      <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <div className="mt-6 flex flex-wrap gap-2">
            {["First Aid", "Search & Rescue", "Water Safety", "Disaster Comms", "Trauma Care"].map(
              (t) => (
          ...
          <Button asChild className="mt-7 rounded-full">
            <Link to="/login">
              Become a volunteer <ArrowRight className="h-4 w-4 ml-1.5" />
            </Link>
          </Button>
        </div>
...
function Testimonials() {
  const t = [
    {
      q: "ResQNet cut our dispatch time in half during the Chennai floods. A genuine paradigm shift.",
      n: "Dr. Anita Rao",
      r: "Director, National Disaster Authority",
    },
    {
      q: "As a volunteer, I finally feel coordinated. Missions are matched to my skills and routed to me instantly.",
      n: "Priya Patel",
      r: "Volunteer · Chennai",
    },
    {
      q: "The AI assistant guided my family through the cyclone hour by hour. We owe a lot to this app.",
      n: "Aarav Sharma",
      r: "Citizen · Mumbai",
    },
  ];
    ...
    <section id="testimonials" className="py-24">
      <div className="mx-auto max-w-6xl px-6">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <h2 className="text-4xl font-bold tracking-tight">
            Trusted in the most critical moments.
          </h2>
        </div>
        ...
        <div className="relative overflow-hidden rounded-3xl border gradient-primary p-12 text-center text-primary-foreground shadow-glow">
          ...
          <div className="relative">
            ...
            <p className="mt-3 text-primary-foreground/80 max-w-xl mx-auto">
              Open the live demo and explore every role: citizen, volunteer, rescue team, and
              authority.
            </p>
