          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-3 gap-3 mt-6">
              <div className="rounded-xl border p-3">
                ...
                <div className="font-medium text-sm">{i.reporter}</div>
              </div>
              <div className="rounded-xl border p-3">
                <div className="text-xs text-muted-foreground">Affected</div>
                <div className="font-medium text-sm">{i.affectedPeople} people</div>
              </div>
              <div className="rounded-xl border p-3">
                <div className="text-xs text-muted-foreground">ETA</div>
                <div className="font-medium text-sm">{i.eta ?? "—"}</div>
              </div>
            </div>
            <div className="mt-6">
            ...
            <CardContent className="p-5">
              ...
              <ul className="space-y-2 text-sm">
                <li className="flex justify-between">
                  <span>{i.assignedTeam ?? "Team Alpha-3"}</span>
