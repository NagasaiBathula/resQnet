      ...
      tableCols={[
        {
          key: "caseId",
          label: "Case",
          render: (r) => <span className="font-mono text-xs">{r.caseId}</span>,
        },
        {
          key: "team",
          label: "Team",
          render: (r) => <span className="text-sm font-medium">{r.team}</span>,
        },
        {
          key: "units",
          label: "Units",
          render: (r) => <span className="text-xs text-muted-foreground">{r.units}</span>,
        },
        ...
        },
        {
          key: "eta",
          label: "ETA",
          render: (r) => <span className="text-xs font-medium">{r.eta}</span>,
        },
      ]}
      ...
      sideCards={[
        {
          ...
          items: channels.slice(0, 6).map((c) => ({
            ...
            value: (
              <PillBadge tone={c.status === "live" ? "success" : "muted"}>
                {c.listeners} on
              </PillBadge>
            ),
          })),
